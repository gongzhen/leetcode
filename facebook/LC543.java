...
public class LC543 {
    ...
    private int dfs(TreeNode node, Height h) {
        if(node == null) {
            return 0;
        }
        ...
        h.height = Math.max(h.height, left + right);
	...
	public static void main(String[] args) {
		LC543 obj = new LC543();		
		// System.out.println(obj.diameterOfBinaryTree(list));
        TreeNode root = obj.createTree();
        obj.printString("res:" + obj.diameterOfBinaryTree_2(root));
	}
