...
public class Solution2 {
    ...
    public int rob(TreeNode root) {        
        if (root == null) {
            printString("line57:end of tree.");
            printLine();
            return 0;
        }

        int v = 0;
        printString("line63:" + root.val);
        if (root.left != null) {
            printString("line65:root.left:" + root.left.val);            
            v = v + rob(root.left.left) + rob(root.left.right);
            printLine();
        }

        if(root.right != null) {
            printString("line71:root.right:" + root.right.val); 
            v = v + rob(root.right.left) + rob(root.right.right);
            printLine();            
        }
        printString("line75:v:" + v); 
